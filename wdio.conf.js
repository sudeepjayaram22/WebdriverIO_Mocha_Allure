...
var file_name = process.env.target || 'config'
...
// If the browser input is not present, chrome is forced
...
let timeout = process.env.DEBUG ? 99999999 : 1800000;
let elementTimeout = 40000;
...
exports.config = {
    ...
    reporters: ['spec', ['allure', { outputDir: 'reports/allure-results', disableWebdriverScreenshotsReporting: false }]],
    //
